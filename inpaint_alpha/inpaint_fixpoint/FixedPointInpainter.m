...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [image]=FixedPointInpainter(original_image,alpha,beta,omega,GSiter,tolerent,max_iteration)
    i = 0;
    image_norm = 999999;
    res_norm = 999999;
    ...
    while i < max_iteration && image_norm > tolerent && res_norm > tolerent 
        last_image = image;
        image = GlobalFixedPoint(image,original_image,alpha,beta,omega,GSiter); 
